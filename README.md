...
No formal installation is required. Download the folders, open MATLAB, add the folders to the MATLAB path, install the listed external dependencies, and update the paths in the main scripts (~10 min excluding installation of MATLAB and external packages/add-ons).
...
Files are organized according to the folder structure: Mouse Label / Sessions (here, "1 hab", "2 cond", "3 ret", and for some experiments "4 fullcond", "5 fullcond") / Date of session / Files from the recordings. 
### sample data and instructions for use
A sample dataset ("SD047_fullcond_S1_CST_miniscope_behavior") has been provided. Update the relevant paths in the MATLAB scripts and run freezing_20240214.m, preprocessing_20250709.m, and analysis1P_master_20250709_ek.m. Additional editable parameters are described below and in the comments within each script. 
