...
function [neuron,saveDir,Coor_prev,directory,sessions]= load_cnmfe_data(directory,filename,imouse,sessions,opt)
...
directory.session_list(find(~cellfun(@isempty,strfind(directory.session_list ,'shock'))))=[];
