...
if contains(folder.parentDir{1}, 'behavior only')
    ...
    stim.session.conditioning=  1:4; % 1:4
    stim.session.US=            2:4; % 2:4
end
...
if contains(folder.parentDir{1},'fullcond_S1_CST_HM4Di_behavior only')
    ...
    stim.session.US=            [2 4 5]; % 2, 2:4
    stim.session.freezing=      1:3; % 2:4
    stim.session.CS=            1:5;
...
if contains(folder.parentDir{1},'fullcond_S1_CST_miniscope_behavior')
    ...
    beh.info.trialD= {
        'trialD 1: tone',...                    % 30
        'trialD 2:        light int.0.5',...    % 10
        'trialD 3:        light int.1',...      % 10
        'trialD 4:        light int.1.5',...    % 10
        'trialD 5: tone + light int.0.5',...    % 10
        'trialD 6: tone + light int.1',...      % 50
        'trialD 7: tone + light int.1.5',...    % 10
        'trialD 8: tone + light int.1 subset'}; % 10
